...
import {
  requireDeliveryAgentRole,
  requireDeliveryAgentProfile,
  DeliveryAgentRequest,
} from '../middleware/deliveryAuth';
 ...
 */
router.post('/profile', requireDeliveryAgentRole, async (req: DeliveryAgentRequest, res: Response) => {
  try {
    const userId = req.user!.sub;
    const existing = await DeliveryAgent.findOne({ userId });
    if (existing) {
 ...
 */
router.get('/profile', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
 ...
 */
router.patch('/availability', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.patch('/location', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.get('/jobs/available', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.get('/jobs/assigned', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.post('/jobs/:id/accept', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.get('/jobs/:id', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.patch('/jobs/:id/status', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.post('/jobs/:id/confirm-pickup', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.post('/jobs/:id/confirm-delivery', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
 ...
 */
router.get('/history', requireDeliveryAgentProfile, async (req: DeliveryAgentRequest, res: Response) => {
  try {
    const { status, limit = 20, page = 1 } = req.query;
    const query: any = { deliveryAgentId: req.deliveryAgent!._id };
