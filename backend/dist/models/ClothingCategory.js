...
exports.ClothingCategory = exports.INITIAL_CATEGORIES = void 0;
exports.seedInitialCategories = seedInitialCategories;
...
const ClothingCategorySchema = new mongoose_1.Schema({
...
ClothingCategorySchema.virtual('categoryId').get(function () {
    return this._id?.toString();
});
exports.ClothingCategory = (0, mongoose_1.model)('ClothingCategory', ClothingCategorySchema);
/**
...
async function seedInitialCategories() {
    try {
        ...
        if (mongoose.connection.readyState !== 1)
            return;
        const count = await exports.ClothingCategory.countDocuments();
        if (count === 0) {
            await exports.ClothingCategory.insertMany(exports.INITIAL_CATEGORIES);
